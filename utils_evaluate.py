...
from evaluation import caculate_bleu, caculate_rouge, caculate_similariry
...
def get_scores(result_data, rationale_data, results_reference, data_file):
    ...
    res_pd = sqa_pd[sqa_pd['split'] == 'test']  # test set tinytest
    ...
    ## Similarity
    model = SentenceTransformer('./models/all-MiniLM-L6-v2').cuda()
